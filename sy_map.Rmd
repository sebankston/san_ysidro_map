...
leaflet() %>% 
  ...
  addCircleMarkers(data = sy_r2, label = sy_r2$barrier_id, popup = ~paste0(sy_r2$barrier_id, "<br/>", sy_r2$pad_id), color = "red", group = "Detailed Required", radius = 6, fillOpacity = .5) %>% 
